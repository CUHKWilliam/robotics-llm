...
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw_rgbd.py --env_name $task --n_exps 25 --ckpt_dir "../../AVDC_real_demo/results/rw-lora-2-fill-water-to-red-cup-with-kettle" --milestone 410  --result_root "../results/results_AVDC_mw-lora-2"
done
