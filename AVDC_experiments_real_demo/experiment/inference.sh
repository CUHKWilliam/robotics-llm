...
for task in "fetch-cube-in-the-safety-box"
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch inference.py --env_name $task --n_exps 25 --ckpt_dir "../../AVDC/results/mw-lora-2-all" --milestone 225 --result_root "../results/results_AVDC_mw-lora-2"
done
