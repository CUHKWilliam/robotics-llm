...
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw_rgbd.py --env_name $task --n_exps 25 --ckpt_dir "../../AVDC/results/mw-lora-2-all-fast" --milestone 325 --result_root "../results/results_AVDC_mw-lora-2"
done
