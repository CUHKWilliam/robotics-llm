...
cotracker = torch.hub.load("facebookresearch/co-tracker", "cotracker2_online").cuda()
    ...
    for camera in cameras:
        ...
        for seed in tqdm(range(n_exps)):
            ...
            if len(images) <= 500:
                ...
                print("success")
                SAVE_PATH = '/media/msc-auto/HDD/wltang/robotic-llm/AVDC/datasets/metaworld/metaworld_dataset_drawer_key'
                # SAVE_PATH = './tmp'
                save_path = SAVE_PATH
                ...
                grid_size = 10
                video = torch.tensor(images).permute(0, 3, 1, 2)[None].float().cuda()
