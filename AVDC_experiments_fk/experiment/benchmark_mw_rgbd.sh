...
for task in "kitchen_micro_open-v3"
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw_rgbd.py --env_name $task --n_exps 25 --ckpt_dir "../../AVDC_fk/results/fk-lora-2-micro-open" --milestone 646  --result_root "../results/results_AVDC_mw-lora-2"
done
